...
Deno.serve(async (req) => {
  try {
    ...
    if (!g33cPreviewRequest && !g35bPreviewRequest && !g35hPreviewRequest && !g35lPreviewRequest && !g36bPreviewRequest && !g36cHelperPreviewRequest && !g36cResolvePreviewRequest && body.mode && body.mode !== 'dry_run') {
