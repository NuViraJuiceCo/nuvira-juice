...
function buildPosRecord({ order, source, eventType, lineItems, paymentStatus }) {
  ...
  return {
    record: compactObject({
      ...
      data_quality_status: sanitizeText(order?.data_quality_status, 80) || 'complete',
      sync_status: sanitizeText(order?.sync_status, 80) || 'native_ops_ready',
      last_sync_at: now,
      ...
      event_id: sanitizeText(order?.event_id, 160),
      event_key: sanitizeText(order?.event_key, 160),
      shopify_pos_location_id: sanitizeText(order?.shopify_pos_location_id, 160),
      shopify_pos_location_name: sanitizeText(order?.shopify_pos_location_name, 160),
      shopify_pos_device_id: sanitizeText(order?.shopify_pos_device_id, 160),
      shopify_pos_staff_id: sanitizeText(order?.shopify_pos_staff_id, 160),
      event_attribution_status: sanitizeText(order?.event_attribution_status, 80),
      event_attribution_reason: sanitizeText(order?.event_attribution_reason, 500),
