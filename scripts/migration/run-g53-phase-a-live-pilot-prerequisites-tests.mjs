...
const gateEnv = {
  ...
  ENABLE_NATIVE_PRODUCTION_BATCH_TEST_LIFECYCLE_WRITES: 'true',
  NATIVE_PRODUCTION_BATCH_LIFECYCLE_ALLOWED_EMAILS: 'info@nuvirajuice.com',
  NATIVE_PRODUCTION_BATCH_LIFECYCLE_TEST_ALLOWED_EMAILS: 'info@nuvirajuice.com',
  NATIVE_PRODUCTION_BATCH_LIFECYCLE_ALLOWED_ACTIONS: 'start,complete,verify',
  NATIVE_PRODUCTION_BATCH_LIFECYCLE_TEST_ALLOWED_ACTIONS: 'start,complete,verify',
