...
const zone3Source = fs.readFileSync('base44/functions/getCustomerAccountDashboardData/handlers/createZone3AuthorizationIntent/entry.ts', 'utf8');
const zone3ApprovalSource = fs.readFileSync('base44/functions/getAdminOperationsDashboardSummary/handlers/approveZone3DeliveryRequest/entry.ts', 'utf8');
...
const adminCommandSource = fs.readFileSync('base44/functions/getAdminOperationsDashboardSummary/handlers/manageAdminDiscountCode/entry.ts', 'utf8');
...
assert.match(adminCommandSource, /idempotency_key: idempotencyKey/);
assert.match(adminCommandSource, /confirmation_required/);
