...
const harnesses = [
  ...
  'scripts/migration/run-live-catalog-reward-parity-tests.mjs',
  'scripts/migration/run-route-review-communications-tests.mjs',
  ...
  'scripts/migration/run-g180-native-provider-browser-tests.mjs',
  ...
  'scripts/migration/run-meta-funnel-capi-tests.mjs',
  'scripts/migration/run-meta-production-origin-tests.mjs',
  ...
  'scripts/migration/run-approved-product-primary-media-tests.mjs',
  ...
  'scripts/migration/run-g173-product-schema-deduplication-tests.mjs',
  'scripts/migration/run-g174-guest-address-lookup-tests.mjs',
];
