...
import { isPreorderMode, LAUNCH_DATE, FIRST_DELIVERY_DATE } from '@/lib/preorderConfig';
      ...
      <div className="bg-primary rounded-2xl p-4 relative overflow-hidden">
        ...
        <div className="flex items-start gap-3 relative">
          ...
          <div className="flex-1">
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-0.5">Official Launch May 1st</p>
            <p className="font-heading text-base font-bold text-white leading-tight">Pre-Order Now</p>
            <p className="text-white/70 text-xs mt-1 leading-relaxed">
              Your card is authorized today but <span className="font-semibold text-white">charged May 1st</span> when we start production. All pre-orders delivered <span className="font-semibold text-white">May 2nd</span>.
            </p>
          </div>
          {daysUntilLaunch > 0 && (
        ...
        <div className="flex items-center gap-1.5 mt-3 relative">
          ...
          <p className="text-[10px] text-white/50">Card authorized now · charged May 1st · delivered May 2nd</p>
        </div>
      </div>
    </motion.div>
  );
