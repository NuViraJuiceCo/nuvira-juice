      ...
      <div className="bg-primary rounded-2xl p-6 relative overflow-hidden">
        ...
        <div className="flex items-start gap-4 relative mb-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/80 mb-2">Coming Soon</p>
            <p className="font-heading text-lg font-bold text-white leading-tight mb-3">We're Launching May 1st</p>
            <p className="text-white text-xs leading-relaxed">
              Get ready for fresh cold-pressed juice. Pre-orders open <span className="font-semibold">April 23rd</span>. Everything ships <span className="font-semibold">May 2nd</span>.
            </p>
          </div>
          {daysUntilLaunch > 0 && (
            <div className="shrink-0 bg-white/15 rounded-xl px-3 py-2 text-center">
              ...
              <p className="text-[9px] text-white/80 font-medium mt-1">days</p>
            </div>
          )}
        </div>

        {/* Footer */}
        <div className="flex items-center gap-1.5 relative pt-3 border-t border-white/20">
          <Clock className="w-3 h-3 text-white/70 shrink-0" />
          <p className="text-[10px] text-white/80">Pre-orders open April 23rd · Delivery May 2nd</p>
        </div>
      </div>
    </motion.div>
  );
