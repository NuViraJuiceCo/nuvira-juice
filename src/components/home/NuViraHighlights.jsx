...
const HIGHLIGHTS = [
  {
    id: 'fresh',
    title: 'Fresh Pressed Daily',
    subtitle: 'Small-batch juices crafted for your delivery.',
    icon: Leaf,
    color: '#0B3D2E',
    accentColor: '#C9A24A',
  },
  {
    ...
    subtitle: 'Scheduled production keeps your juice fresh.',
    icon: Truck,
    color: '#0B3D2E',
    accentColor: '#C9A24A',
  },
  {
    id: 'rewards',
    title: 'Earn Rewards',
    subtitle: '10 points per $1 spent. Redeem anytime.',
    icon: Star,
    color: '#0B3D2E',
    accentColor: '#C9A24A',
  },
  {
    id: 'wellness',
    title: 'Real Wellness',
    subtitle: 'No shortcuts. No fillers. Just juice.',
    icon: Sparkles,
    color: '#0B3D2E',
    accentColor: '#C9A24A',
  },
