...
export default function ProgramCards() {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex gap-4 overflow-x-auto overflow-y-visible pb-2 scrollbar-none px-5" style={{ scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch', touchAction: 'pan-y' }}>
