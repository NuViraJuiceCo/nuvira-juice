...
export const SEO_LANDING_PAGES = {
  'cold-pressed-juice-delivery': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Order single bottles, wellness shots, bundles, or 3-day programs online. Delivery availability depends on your address and the current schedule shown at checkout.',
      },
      {
    ...
    faqs: [
      ...
      ['Can I order individual bottles and programs?', 'Yes. The shop includes single bottles, wellness shots, bundles, and structured 3-day programs.'],
    ],
  },
  'fresh-juice-delivery-st-louis': {
    ...
    metaDescription: 'Fresh juice delivery for St. Louis area customers. Shop NuVira cold-pressed juices, bundles, wellness shots, and 3-day programs online.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Start with single bottles, build a trio, or choose a 3-day program when you want a structured fridge reset.',
      },
    ],
    highlights: ['Fresh juice', 'Local delivery', 'Single bottles', '3-day programs'],
    faqs: [
  ...
  'cold-pressed-juice-wentzville': {
    ...
    metaDescription: 'NuVira Juice Co. offers cold-pressed juice in Wentzville, MO with local delivery, fresh bottles, wellness shots, and 3-day juice programs.',
  ...
  'juice-cleanse-wentzville': {
    ...
    title: '3-Day Juice Programs in Wentzville, MO',
    h1: '3-Day Juice Programs in Wentzville, MO',
    eyebrow: 'Structured juice programs',
    summary: 'NuVira 3-day juice programs are built for customers who want a clear, organized bottle plan without guessing what to order.',
    metaDescription: 'Shop 3-day NuVira juice programs in Wentzville, MO. Hydration, Radiance, and Reset programs include fresh cold-pressed bottles delivered locally.',
    keywords: 'juice cleanse Wentzville, juice program Wentzville, 3 day juice cleanse Missouri, cold pressed juice cleanse near me',
    image: DELIVERY_URL,
    icon: Calendar,
    serviceType: '3-day juice programs',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Hydration, Radiance, and Reset are designed for different customer goals while keeping the order experience simple.',
      },
    ],
    highlights: ['Hydration Program', 'Radiance Program', 'Reset Program', '12-bottle structure'],
    faqs: [
  ...
  'cold-pressed-juice-ofallon-mo': {
    ...
    summary: "NuVira gives O'Fallon customers a nearby source for fresh cold-pressed juices, wellness shots, bundles, and 3-day programs.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Order OASIS, AURA, RE-NU, wellness shots, the NuVira Trio, or a structured 3-day program.',
      },
    ],
    ...
    faqs: [
      ...
      ['Can I order a 3-day program?', 'Yes. Hydration, Radiance, and Reset programs are available from the shop and program pages.'],
  ...
  'juice-delivery-st-charles-mo': {
    ...
    metaDescription: 'Fresh juice delivery near St. Charles, MO. Shop NuVira cold-pressed juices, wellness shots, bundles, and 3-day programs online.',
    keywords: 'juice delivery St. Charles MO, cold pressed juice St. Charles, fresh juice St. Charles, juice cleanse St. Charles',
    image: FRESH_URL,
    icon: Truck,
    ...
    highlights: ['St. Charles area', 'Delivery windows', 'Fresh bottles', '3-day programs'],
    faqs: [
  ...
  'juice-delivery-lake-saint-louis': {
    ...
    summary: 'NuVira serves Lake Saint Louis area customers with fresh cold-pressed juices, wellness shots, bundles, and structured 3-day programs.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Start with single bottles, pick a trio, add shots, or choose a 3-day program when you want structure.',
      },
    ],
  ...
  'wellness-shots-wentzville': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Customers often pair shots with single bottles, the NuVira Trio, or structured 3-day programs.',
      },
    ],
